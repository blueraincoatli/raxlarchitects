...
const p = r => typeof r == "string",
    ...
    _e = /###/g,
    ge = r => r && r.indexOf("###") > -1 ? r.replace(_e, ".") : r,
    pe = r => !r || p(r),
    _ = (r, e, t) => {
    ...
    me = (r, e, t) => {
        ...
        let i = e[e.length - 1],
            ...
            o = _(r, a, Object);
        for (; o.obj === void 0 && a.length;) i = `${a[a.length-1]}.${i}`, a = a.slice(0, a.length - 1), o = _(r, a, Object), o?.obj && typeof o.obj[`${o.k}.${i}`] < "u" && (o.obj = void 0);
        o.obj[`${o.k}.${i}`] = t
    },
    Je = (r, e, t, s) => {
        const {
    ...
    je = (r, e, t) => {
        for (const s in e) s !== "__proto__" && s !== "constructor" && (s in r ? p(r[s]) || r[s] instanceof String || p(e[s]) || e[s] instanceof String ? t && (r[s] = e[s]) : je(r[s], e[s], t) : r[s] = e[s]);
        return r
    },
    K = r => r.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var qe = {
...
const Qe = r => p(r) ? r.replace(/[&<>"'\/]/g, e => qe[e]) : r;
class Ye {
    constructor(e) {
...
const Ge = [" ", ",", "?", "!", ";"],
    ...
    Xe = (r, e, t) => {
        e = e || "", t = t || "";
        const s = Ge.filter(a => e.indexOf(a) < 0 && t.indexOf(a) < 0);
        if (s.length === 0) return !0;
        const n = Ze.getRegExp(`(${s.map(a=>a==="?"?"\\?":a).join("|")})`);
        let i = !n.test(r);
        if (!i) {
            const a = r.indexOf(t);
    ...
    oe = (r, e, t = ".") => {
        ...
        for (let i = 0; i < s.length;) {
            ...
            for (let l = i; l < s.length; ++l)
                if (l !== i && (o += t), o += s[l], a = n[o], a !== void 0) {
...
class te {
    ...
    emit(e, ...t) {
        this.observers[e] && Array.from(this.observers[e].entries()).forEach(([n, i]) => {
            ...
            for (let a = 0; a < i; a++) n.apply(n, [e, ...t])
        })
    }
}
class ye extends te {
    ...
    getResource(e, t, s, n = {}) {
        ...
        let o;
        e.indexOf(".") > -1 ? o = e.split(".") : (o = [e, t], s && (Array.isArray(s) ? o.push(...s) : p(s) && i ? o.push(...s.split(i)) : o.push(s)));
        const l = Z(this.data, o);
        return !l && !t && !s && e.indexOf(".") > -1 && (e = o[0], t = o[1], s = o.slice(2).join(".")), l || !a || !p(s) ? l : oe(this.data?.[e]?.[t], s, i)
    }
    addResource(e, t, s, n, i = {
        silent: !1
    }) {
        const a = i.keySeparator !== void 0 ? i.keySeparator : this.options.keySeparator;
        let o = [e, t];
        s && (o = o.concat(a ? s.split(a) : s)), e.indexOf(".") > -1 && (o = e.split("."), n = t, t = o[1]), this.addNamespaces(t), me(this.data, o, n), i.silent || this.emit("added", e, t, s, n)
    }
    addResources(e, t, s, n = {
        silent: !1
    }) {
        for (const i in s)(p(s[i]) || Array.isArray(s[i])) && this.addResource(e, t, i, s[i], {
            silent: !0
        });
        n.silent || this.emit("added", e, t, s)
    }
    addResourceBundle(e, t, s, n, i, a = {
        silent: !1,
        skipCopy: !1
    }) {
        let o = [e, t];
        ...
        let l = Z(this.data, o) || {};
        a.skipCopy || (s = JSON.parse(JSON.stringify(s))), n ? je(l, s, i) : l = {
            ...l,
            ...s
        }, me(this.data, o, l), a.silent || this.emit("added", e, t, s)
    }
...
var Te = {
    ...
    handle(r, e, t, s, n) {
        return r.forEach(i => {
            e = this.processors[i]?.process(e, t, s, n) ?? e
        }), e
    }
};
const De = Symbol("i18next/PATH_KEY");

function tt() {
    const r = [],
        e = Object.create(null);
    let t;
    return e.get = (s, n) => (t?.revoke?.(), n === De ? r : (r.push(n), t = Proxy.revocable(s, e), t.proxy)), Proxy.revocable(Object.create(null), e).proxy
}
...
const xe = {},
    se = r => !p(r) && typeof r != "boolean" && typeof r != "number";
class ee extends te {
    constructor(e, t = {}) {
        super(), Be(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = j.create("translator")
    }
    changeLanguage(e) {
        e && (this.language = e)
    }
    ...
    translate(e, t, s) {
        ...
        if (c?.toLowerCase() === "cimode") return d ? i ? {
            res: `${u}${f}${o}`,
            usedKey: o,
            exactUsedKey: o,
            usedLng: c,
        ...
        const x = g?.usedKey || o,
            ...
            L = n.count !== void 0 && !p(n.count),
            R = ee.hasDefaultValue(n),
            F = L ? this.pluralResolver.getSuffix(c, n.count, n) : "",
            T = n.ordinal && L ? this.pluralResolver.getSuffix(c, n.count, {
                ordinal: !1
            }) : "",
            q = L && !n.ordinal && n.count === 0,
            y = q && n[`defaultValue${this.options.pluralSeparator}zero`] || n[`defaultValue${F}`] || n[`defaultValue${T}`] || n.defaultValue;
        let m = h;
        k && !h && R && (m = y);
        const S = se(m),
            O = Object.prototype.toString.apply(m);
        if (k && m && S && $.indexOf(O) < 0 && !(p(w) && Array.isArray(m))) {
            if (!n.returnObjects && !this.options.returnObjects) {
                this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
                const v = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(x, m, {
                    ...n,
                    ns: l
                }) : `key '${o} (${this.language})' returned an object instead of string.`;
                return i ? (g.res = v, g.usedParams = this.getUsedParamsDetails(n), g) : v
            }
            if (a) {
                ...
                for (const I in m)
                    if (Object.prototype.hasOwnProperty.call(m, I)) {
                        const D = `${Q}${a}${I}`;
                        R && !h ? P[I] = this.translate(D, {
                            ...n,
                            defaultValue: se(y) ? y[I] : void 0,
                            joinArrays: !1,
                            ns: l
                        }) : P[I] = this.translate(D, {
                            ...n,
                            joinArrays: !1,
                            ns: l
                        }), P[I] === D && (P[I] = m[I])
        ...
        } else if (k && p(w) && Array.isArray(h)) h = h.join(w), h && (h = this.extendTranslation(h, e, n, s));
        else {
            let v = !1,
                P = !1;
            !this.isValidLookup(h) && R && (v = !0, h = y), this.isValidLookup(h) || (P = !0, h = o);
            const I = (n.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && P ? void 0 : h,
                D = R && y !== h && this.options.updateMissing;
            if (P || v || D) {
                if (this.logger.log(D ? "updateKey" : "missingKey", c, u, o, D ? y : h), a) {
                ...
                let H = [];
                const Y = this.languageUtils.getFallbackCodes(this.options.fallbackLng, n.lng || this.language);
                if (this.options.saveMissingTo === "fallback" && Y && Y[0])
                    for (let E = 0; E < Y.length; E++) H.push(Y[E]);
                ...
                const fe = (E, A, z) => {
                    const de = R && z !== h ? z : I;
                    this.options.missingKeyHandler ? this.options.missingKeyHandler(E, u, A, de, D, n) : this.backendConnector?.saveMissing && this.backendConnector.saveMissing(E, u, A, de, D, n), this.emit("missingKey", E, u, A, h)
                };
                this.options.saveMissing && (this.options.saveMissingPlurals && L ? H.forEach(E => {
                    const A = this.pluralResolver.getSuffixes(E, n);
                    q && n[`defaultValue${this.options.pluralSeparator}zero`] && A.indexOf(`${this.options.pluralSeparator}zero`) < 0 && A.push(`${this.options.pluralSeparator}zero`), A.forEach(z => {
                        fe([E], o + z, n[`defaultValue${z}`] || y)
                    })
                }) : fe(H, o, y))
            }
            h = this.extendTranslation(h, e, n, g, s), P && h === o && this.options.appendNamespaceToMissingKey && (h = `${u}${f}${o}`), (P || v) && this.options.parseMissingKeyHandler && (h = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${u}${f}${o}` : o, v ? h : void 0, n))
        }
        return i ? (g.res = h, g.usedParams = this.getUsedParamsDetails(n), g) : h
    }
    extendTranslation(e, t, s, n, i) {
        if (this.i18nFormat?.parse) e = this.i18nFormat.parse(e, {
            ...
            const l = p(e) && (s?.interpolation?.skipOnVariables !== void 0 ? s.interpolation.skipOnVariables : this.options.interpolation.skipOnVariables);
            let u;
            if (l) {
                const c = e.match(this.interpolator.nestingRegexp);
                u = c && c.length
            }
            let f = s.replace && !p(s.replace) ? s.replace : s;
            if (this.options.interpolation.defaultVariables && (f = {
                ...
                const c = e.match(this.interpolator.nestingRegexp),
                    d = c && c.length;
                u < d && (s.nest = !1)
            }!s.lng && n && n.res && (s.lng = this.language || n.usedLng), s.nest !== !1 && (e = this.interpolator.nest(e, (...c) => i?.[0] === c[0] && !s.context ? (this.logger.warn(`It seems you are nesting recursively key: ${c[0]} in key: ${t[0]}`), null) : this.translate(...c, t), s)), s.interpolation && this.interpolator.reset()
        }
        const a = s.postProcess || this.options.postProcess,
            o = p(a) ? [a] : a;
        return e != null && o?.length && s.applyPostProcessor !== !1 && (e = Te.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
            i18nResolved: {
                ...n,
    ...
    resolve(e, t = {}) {
        ...
        return p(e) && (e = [e]), e.forEach(l => {
            ...
            const d = t.count !== void 0 && !p(t.count),
                g = d && !t.ordinal && t.count === 0,
                h = t.context !== void 0 && (p(t.context) || typeof t.context == "number") && t.context !== "",
                x = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
            c.forEach(b => {
                this.isValidLookup(s) || (o = b, !xe[`${x[0]}-${b}`] && this.utils?.hasLoadedNamespace && !this.utils?.hasLoadedNamespace(o) && (xe[`${x[0]}-${b}`] = !0, this.logger.warn(`key "${n}" for languages "${x.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), x.forEach($ => {
                    if (this.isValidLookup(s)) return;
                    a = $;
                    const w = [f];
                    if (this.i18nFormat?.addLookupKeys) this.i18nFormat.addLookupKeys(w, f, $, b, t);
                    else {
                        let L;
                        d && (L = this.pluralResolver.getSuffix($, t.count, t));
                        const R = `${this.options.pluralSeparator}zero`,
                            F = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
                        if (d && (t.ordinal && L.indexOf(F) === 0 && w.push(f + L.replace(F, this.options.pluralSeparator)), w.push(f + L), g && w.push(f + R)), h) {
                            const T = `${f}${this.options.contextSeparator||"_"}${t.context}`;
                            w.push(T), d && (t.ordinal && L.indexOf(F) === 0 && w.push(T + L.replace(F, this.options.pluralSeparator)), w.push(T + L), g && w.push(T + R))
                        }
                    }
                    let k;
                    for (; k = w.pop();) this.isValidLookup(s) || (i = k, s = this.getResource($, b, k, t))
                }))
            })
        }), {
            res: s,
...
class Se {
    ...
    getBestMatchFromCodes(e) {
        ...
        return e.forEach(s => {
            ...
            t = this.options.supportedLngs.find(a => {
                if (a === i) return a;
                if (!(a.indexOf("-") < 0 && i.indexOf("-") < 0) && (a.indexOf("-") > 0 && i.indexOf("-") < 0 && a.substring(0, a.indexOf("-")) === i || a.indexOf(i) === 0 && i.length > 1)) return a
            })
    ...
    toResolveHierarchy(e, t) {
        ...
        return p(e) && (e.indexOf("-") > -1 || e.indexOf("_") > -1) ? (this.options.load !== "languageOnly" && i(this.formatLanguageCode(e)), this.options.load !== "languageOnly" && this.options.load !== "currentOnly" && i(this.getScriptPartFromCode(e)), this.options.load !== "currentOnly" && i(this.getLanguagePartFromCode(e))) : p(e) && i(this.formatLanguageCode(e)), s.forEach(a => {
...
class st {
    ...
    getRule(e, t = {}) {
        ...
        try {
            ...
            if (!Intl) return this.logger.error("No Intl support, please use an Intl polyfill!"), we;
    ...
    getSuffixes(e, t = {}) {
        let s = this.getRule(e, t);
        return s || (s = this.getRule("dev", t)), s ? s.resolvedOptions().pluralCategories.sort((n, i) => be[n] - be[i]).map(n => `${this.options.prepend}${t.ordinal?`ordinal${this.options.prepend}`:""}${n}`) : []
    }
    getSuffix(e, t, s = {}) {
...
const Oe = (r, e, t, s = ".", n = !0) => {
        let i = We(r, e, t);
        return !i && n && p(t) && (i = oe(r, t, s), i === void 0 && (i = oe(e, t, s))), i
    },
    ne = r => r.replace(/\$/g, "$$$$");
class Le {
    constructor(e = {}) {
    ...
    init(e = {}) {
        ...
        this.escape = t !== void 0 ? t : Qe, this.escapeValue = s !== void 0 ? s : !0, this.useRawValueToEscape = n !== void 0 ? n : !1, this.prefix = i ? K(i) : a || "{{", this.suffix = o ? K(o) : l || "}}", this.formatSeparator = u || ",", this.unescapePrefix = f ? "" : c || "-", this.unescapeSuffix = this.unescapePrefix ? "" : f || "", this.nestingPrefix = d ? K(d) : g || K("$t("), this.nestingSuffix = h ? K(h) : x || K(")"), this.nestingOptionsSeparator = b || ",", this.maxReplaces = $ || 1e3, this.alwaysFormat = w !== void 0 ? w : !1, this.resetRegExp()
    }
    reset() {
    ...
    interpolate(e, t, s, n) {
        ...
        const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {},
            u = g => {
                if (g.indexOf(this.formatSeparator) < 0) {
                    const $ = Oe(t, l, g, this.options.keySeparator, this.options.ignoreJSONStructure);
                ...
                const h = g.split(this.formatSeparator),
                    x = h.shift().trim(),
                    b = h.join(this.formatSeparator).trim();
                return this.format(Oe(t, l, x, this.options.keySeparator, this.options.ignoreJSONStructure), b, s, {
                    ...n,
                    ...t,
                    interpolationkey: x
                })
        ...
        return [{
            ...
            regex: this.regexp,
            safeValue: g => this.escapeValue ? ne(this.escape(g)) : ne(g)
        }].forEach(g => {
            for (o = 0; i = g.regex.exec(e);) {
                ...
                if (a = u(h), a === void 0)
                    if (typeof f == "function") {
                        const b = f(e, i, n);
                        a = p(b) ? b : ""
                    } else if (n && Object.prototype.hasOwnProperty.call(n, h)) a = "";
                else if (c) {
                    a = i[0];
                    continue
                } else this.logger.warn(`missed to pass in variable ${h} for interpolating ${e}`), a = "";
                else !p(a) && !this.useRawValueToEscape && (a = he(a));
                const x = g.safeValue(a);
                if (e = e.replace(i[0], x), c ? (g.regex.lastIndex += a.length, g.regex.lastIndex -= i[0].length) : g.regex.lastIndex = 0, o++, o >= this.maxReplaces) break
            }
        }), e
    }
    nest(e, t, s = {}) {
        ...
        const o = (l, u) => {
            ...
            let d = `{${c[1]}`;
            l = c[0], d = this.interpolate(d, a);
            const g = d.match(/'/g),
                h = d.match(/"/g);
            ((g?.length ?? 0) % 2 === 0 && !h || h.length % 2 !== 0) && (d = d.replace(/'/g, '"'));
            try {
                a = JSON.parse(d), u && (a = {
                    ...u,
                    ...a
                ...
                return this.logger.warn(`failed parsing options string in nesting for key ${l}`, x), `${l}${f}${d}`
            }
        ...
        for (; n = this.nestingRegexp.exec(e);) {
            ...
            if (u !== -1 && (l = n[1].slice(u).split(this.formatSeparator).map(f => f.trim()).filter(Boolean), n[1] = n[1].slice(0, u)), i = t(o.call(this, n[1].trim(), a), a), i && n[0] === e && !p(i)) return i;
            p(i) || (i = he(i)), i || (this.logger.warn(`missed to resolve ${n[1]} for nesting ${e}`), i = ""), l.length && (i = l.reduce((f, c) => this.format(f, c, s.lng, {
                ...s,
...
const nt = r => {
    ...
    ve = r => {
        ...
        return (t, s, n) => {
            ...
            let o = e[a];
            return o || (o = r(W(s), n), e[a] = o), o(t)
        }
    },
    it = r => (e, t, s) => r(W(t), s)(e);
class rt {
    constructor(e = {}) {
    ...
    init(e, t = {
        ...
        const s = t.cacheInBuiltFormats ? ve : it;
        this.formats = {
            number: s((n, i) => {
    ...
    format(e, t, s, n = {}) {
        ...
        return i.reduce((o, l) => {
            ...
            if (this.formats[u]) {
                let c = o;
                try {
                    const d = n?.formatParams?.[n.interpolationkey] || {},
                        g = d.locale || d.lng || n.locale || n.lng || s;
...
class ot extends te {
    ...
    queueLoad(e, t, s, n) {
        ...
        return e.forEach(u => {
            ...
            t.forEach(c => {
                const d = `${u}|${c}`;
                !s.reload && this.store.hasResourceBundle(u, c) ? this.state[d] = 2 : this.state[d] < 0 || (this.state[d] === 1 ? a[d] === void 0 && (a[d] = !0) : (this.state[d] = 1, f = !1, a[d] === void 0 && (a[d] = !0), i[d] === void 0 && (i[d] = !0), l[c] === void 0 && (l[c] = !0)))
            }), f || (o[u] = !0)
    ...
    loaded(e, t, s) {
        ...
        this.queue.forEach(l => {
            Je(l.loaded, [i], a), at(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach(u => {
                o[u] || (o[u] = {});
                const f = l.loaded[u];
    ...
    read(e, t, s, n = 0, i = this.retryTimeout, a) {
    ...
    loadOne(e, t = "") {
        const s = e.split("|"),
            n = s[0],
            i = s[1];
        this.read(n, i, "read", void 0, void 0, (a, o) => {
            a && this.logger.warn(`${t}loading namespace ${i} for language ${n} failed`, a), !a && o && this.logger.log(`${t}loaded namespace ${i} for language ${n}`, o), this.loaded(e, a, o)
        })
    }
    saveMissing(e, t, s, n, i, a = {}, o = () => {}) {
...
const ie = () => ({
    ...
    Ce = r => (p(r.ns) && (r.ns = [r.ns]), p(r.fallbackLng) && (r.fallbackLng = [r.fallbackLng]), p(r.fallbackNS) && (r.fallbackNS = [r.fallbackNS]), r.supportedLngs?.indexOf?.("cimode") < 0 && (r.supportedLngs = r.supportedLngs.concat(["cimode"])), typeof r.initImmediate == "boolean" && (r.initAsync = r.initImmediate), r),
    G = () => {},
    lt = r => {
...
class J extends te {
    constructor(e = {}, t) {
        if (super(), this.options = Ce(e), this.services = {}, this.logger = j, this.modules = {
                external: []
    ...
    loadResources(e, t = G) {
        ...
        if (typeof e == "function" && (s = e), !this.options.resources || this.options.partialBundledLanguages) {
            ...
            n ? a(n) : this.services.languageUtils.getFallbackCodes(this.options.fallbackLng).forEach(l => a(l)), this.options.preload?.forEach?.(o => a(o)), this.services.backendConnector.load(i, this.options.ns, o => {
    ...
    reloadResources(e, t, s) {
        const n = B();
        return typeof e == "function" && (s = e, e = void 0), typeof t == "function" && (s = t, t = void 0), e || (e = this.languages), t || (t = this.options.ns), s || (s = G), this.services.backendConnector.reload(e, t, i => {
            n.resolve(), s(i)
        }), n
    }
    use(e) {
    ...
    changeLanguage(e, t) {
        ...
        const n = o => {
            ...
            a = o => {
                ...
                const l = p(o) ? o : o && o[0],
                    u = this.store.hasLanguageSomeTranslations(l) ? l : this.services.languageUtils.getBestMatchFromCodes(p(o) ? [o] : o);
    ...
    getFixedT(e, t, s) {
        const n = (i, a, ...o) => {
            ...
            let f;
            return l.keyPrefix && Array.isArray(i) ? f = i.map(c => (typeof c == "function" && (c = le(c, {
                ...this.options,
                ...a
            })), `${l.keyPrefix}${u}${c}`)) : (typeof i == "function" && (i = le(i, {
                ...this.options,
                ...a
            })), f = l.keyPrefix ? `${l.keyPrefix}${u}${i}` : i), this.t(f, l)
        };
        return p(e) ? n.lng = e : n.lngs = e, n.ns = t, n.keyPrefix = s, n
    }
    t(...e) {
    ...
    loadLanguages(e, t) {
        ...
        const n = this.options.preload || [],
            i = e.filter(a => n.indexOf(a) < 0 && this.services.languageUtils.isSupportedCode(a));
    ...
    dir(e) {
        ...
        const t = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"],
            s = this.services?.languageUtils || new Se(ie());
    ...
    static createInstance(e = {}, t) {
        const s = new J(e, t);
        return s.createInstance = J.createInstance, s
    }
    cloneInstance(e = {}, t = G) {
        ...
        if ((e.debug !== void 0 || e.prefix !== void 0) && (i.logger = i.logger.clone(e)), ["store", "services", "language"].forEach(o => {
            ...
            i.store = new ye(o, n), i.services.resourceStore = i.store
        }
        if (e.interpolation) {
            const l = {
                    ...ie().interpolation,
            ...
            i.services.interpolator = new Le(u)
        }
        return i.translator = new ee(i.services, n), i.translator.on("*", (o, ...l) => {
            i.emit(o, ...l)
...
const ut = (r, e, t, s) => {
        ...
        if (r?.services?.logger?.forward) return r.services.logger.forward(n, "warn", "react-i18next::", !0);
        U(n[0]) && (n[0] = `react-i18next:: ${n[0]}`), r?.services?.logger?.warn ? r.services.logger.warn(...n) : console?.warn && console.warn(...n)
    },
    ke = {},
    Ae = (r, e, t, s) => {
        U(t) && ke[t] || (U(t) && (ke[t] = new Date), ut(r, e, t, s))
    },
    Ue = (r, e) => () => {
    ...
    ue = (r, e, t) => {
        r.loadNamespaces(e, Ue(r, t))
    },
    Re = (r, e, t, s) => {
        if (U(t) && (t = [t]), r.options.preload && r.options.preload.indexOf(e) > -1) return ue(r, t, s);
        t.forEach(n => {
            r.options.ns.indexOf(n) < 0 && r.options.ns.push(n)
        }), r.loadLanguages(e, Ue(r, s))
    },
    ct = (r, e, t = {}) => !e.languages || !e.languages.length ? (Ae(e, "NO_LANGUAGES", "i18n.languages were undefined or empty", {
        languages: e.languages
    }), !0) : e.hasLoadedNamespace(r, {
        lng: t.lng,
        precheck: (s, n) => {
            if (t.bindI18n && t.bindI18n.indexOf("languageChanging") > -1 && s.services.backendConnector.backend && s.isLanguageChangingTo && !n(s.isLanguageChangingTo, r)) return !1
        }
    }),
    U = r => typeof r == "string",
    ft = r => typeof r == "object" && r !== null,
    dt = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g,
    ht = {
        "&amp;": "&",
        "&#38;": "&",
        "&lt;": "<",
...
function wt() {
    ...
    function o(c, d) {
        var g = d(),
            ...
            b = h[1];
        return i(function() {
            x.value = g, x.getSnapshot = d, l(x) && b({
                inst: x
            })
        }, [c, g, d]), n(function() {
            return l(x) && b({
    ...
    var f = typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u" ? u : o;
    return ae.useSyncExternalStore = r.useSyncExternalStore !== void 0 ? r.useSyncExternalStore : f, ae
}
var Ne;

function Ot() {
    return Ne || (Ne = 1, re.exports = wt()), re.exports
}
var Lt = Ot();
const vt = (r, e) => U(e) ? e : ft(e) && U(e.defaultValue) ? e.defaultValue : Array.isArray(r) ? r[r.length - 1] : r,
    Ct = {
        t: vt,
        ready: !1
    },
    ...
    _t = (r, e = {}) => {
        const {
            ...
            i18n: s,
            defaultNS: n
        } = C.useContext(Ve) || {}, i = t || s || St();
        i && !i.reportNamespaces && (i.reportNamespaces = new bt), i || Ae(i, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
        const a = C.useMemo(() => ({
                ...yt(),
                ...i?.options?.react,
                ...e
            ...
            u = n || i?.options?.defaultNS,
            f = U(u) ? [u] : u || ["translation"],
            c = C.useMemo(() => f, f);
        ...
        const d = C.useRef(0),
            g = C.useCallback(y => {
                ...
                return m && i.on(m, O), S && i.store.on(S, O), () => {
                    m && m.split(" ").forEach(v => i.off(v, O)), S && S.split(" ").forEach(v => i.store.off(v, O))
                }
            }, [i, a]),
            h = C.useRef(),
            x = C.useCallback(() => {
                if (!i) return Ct;
                const y = !!(i.isInitialized || i.initializedStoreOnce) && c.every(Q => ct(Q, i, a)),
                    m = e.lng || i.language,
                    S = d.current,
                    O = h.current;
                if (O && O.ready === y && O.lng === m && O.keyPrefix === l && O.revision === S) return O;
                const P = {
                    t: i.getFixedT(m, a.nsMode === "fallback" ? c : c[0], l),
                    ready: y,
                    lng: m,
                    keyPrefix: l,
                    revision: S
                };
                return h.current = P, P
            }, [i, c, l, a, e.lng]),
            [b, $] = C.useState(0),
            {
                t: w,
                ready: k
            } = Lt.useSyncExternalStore(g, x, x);
        C.useEffect(() => {
            if (i && !k && !o) {
                const y = () => $(m => m + 1);
                e.lng ? Re(i, e.lng, c, y) : ue(i, c, y)
            }
        }, [i, e.lng, c, k, o, b]);
        const L = i || {},
            R = C.useRef(null),
            ...
            q = C.useMemo(() => {
                const y = L,
                    m = y?.language;
                let S = y;
                y && (R.current && R.current.__original === y ? F.current !== m ? (S = T(y), R.current = S, F.current = m) : S = R.current : (S = T(y), R.current = S, F.current = m));
                const O = [w, S, k];
                return O.t = w, O.i18n = S, O.ready = k, O
            }, [w, L, k, L.resolvedLanguage, L.language, L.languages]);
        if (i && o && !k) throw new Promise(y => {
            const m = () => y();
            e.lng ? Re(i, e.lng, c, m) : ue(i, c, m)
        });
        return q
    };
...
function Nt(r) {
    return Pt.call(Rt.call(arguments, 1), e => {
        if (e)
            for (const t in e) r[t] === void 0 && (r[t] = e[t])
    }), r
}
...
const $e = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
    Et = function(r, e) {
        ...
        if (s.httpOnly && (i += "; HttpOnly"), s.secure && (i += "; Secure"), s.sameSite) switch (typeof s.sameSite == "string" ? s.sameSite.toLowerCase() : s.sameSite) {
            case !0:
                i += "; SameSite=Strict";
                break;
            case "lax":
    ...
    Ee = {
        create(r, e, t, s) {
            ...
            t && (n.expires = new Date, n.expires.setTime(n.expires.getTime() + t * 60 * 1e3)), s && (n.domain = s), document.cookie = Et(r, e, n)
        },
        read(r) {
            const e = `${r}=`,
...
var Ft = {
        ...
        lookup(r) {
            ...
            if (e && typeof document < "u") return Ee.read(e) || void 0
        },
        cacheUserLanguage(r, e) {
            ...
            t && typeof document < "u" && Ee.create(t, r, s, n, i)
        }
    },
    It = {
        name: "querystring",
        lookup(r) {
            ...
            if (typeof window < "u") {
                ...
                for (let a = 0; a < i.length; a++) {
                    const o = i[a].indexOf("=");
                    o > 0 && i[a].substring(0, o) === e && (t = i[a].substring(o + 1))
                }
            }
            return t
        }
...
var Tt = {
    ...
    lookup(r) {
        ...
        if (e && Fe()) return window.localStorage.getItem(e) || void 0
    },
    cacheUserLanguage(r, e) {
        let {
            lookupLocalStorage: t
        } = e;
        t && Fe() && window.localStorage.setItem(t, r)
    }
};
let M = null;
const Ie = () => {
    if (M !== null) return M;
    try {
        if (M = typeof window < "u" && window.sessionStorage !== null, !M) return !1;
        const r = "i18next.translate.boo";
...
var Dt = {
        ...
        lookup(r) {
            ...
            if (e && Ie()) return window.sessionStorage.getItem(e) || void 0
        },
        cacheUserLanguage(r, e) {
            let {
                lookupSessionStorage: t
            } = e;
            t && Ie() && window.sessionStorage.setItem(t, r)
        }
    },
    At = {
        name: "navigator",
...
const He = ["querystring", "cookie", "localStorage", "sessionStorage", "navigator", "htmlTag"];
Me || He.splice(1, 1);
const Mt = () => ({
    order: He,
...
class Ht {
    ...
    init() {
        ...
        this.services = e, this.options = Nt(t, this.options || {}, Mt()), typeof this.options.convertDetectedLanguage == "string" && this.options.convertDetectedLanguage.indexOf("15897") > -1 && (this.options.convertDetectedLanguage = n => n.replace("-", "_")), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = s, this.addDetector(Ft), this.addDetector(It), this.addDetector(Tt), this.addDetector(Dt), this.addDetector(At), this.addDetector(Ut), this.addDetector(Kt), this.addDetector(Vt), this.addDetector(jt)
    }
    addDetector(e) {
    ...
    detect() {
        ...
        }), t = t.filter(s => s != null && !$t(s)).map(s => this.options.convertDetectedLanguage(s)), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null
    }
    cacheUserLanguage(e) {
...
Ht.type = "languageDetector";
export {
    Ht as B, Jt as I, Bt as a, N as i, _t as u
};